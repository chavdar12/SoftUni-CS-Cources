namespace CollectionOfPersonsTests.Correctness;
...
public class CorrectnessTests
{
    ...
    public void AddPerson_DuplicatedEmail_ShouldWorkCorrectly()
    {
        ...
        // Assert
        Assert.That(isAddedFirst);
        Assert.That(isAddedSecond, Is.False);
        Assert.That(persons.Count, Is.EqualTo(1));
    }
    ...
    public void DeletePerson_ShouldWorkCorrectly()
    {
        ...
        // Assert
        Assert.That(isDeletedExisting);
        Assert.That(isDeletedNonExisting, Is.False);
    ...
    public void FindPersonsByEmailDomain_ShouldReturnMatchingPersons()
    {
        ...
        CollectionAssert.AreEqual(
            new[] { "ani@gmail.com", "mary@gmail.com", "pesho@gmail.com" },
            personsGmail.Select(p => p.Email).ToList());
        CollectionAssert.AreEqual(
            new[] { "kiro@yahoo.co.uk" },
    ...
    public void FindPersonsByAgeRange_ShouldReturnMatchingPersons()
    {
        ...
        CollectionAssert.AreEqual(
            new string[]
            {
                "ani@gmail.com", "asen@gmail.com", "pepi@gmail.com", "pepi2@yahoo.fr", "kiro@yahoo.co.uk",
                "pesho@gmail.com"
            },
    ...
    public void FindPersonsByAgeRangeAndTown_ShouldReturnMatchingPersons()
    {
        ...
        CollectionAssert.AreEqual(
            new string[]
                { "asen@gmail.com", "pepi@gmail.com", "pepi2@yahoo.fr", "kiro@yahoo.co.uk", "pesho@gmail.com" },
