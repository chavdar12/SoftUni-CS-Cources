...
{
    private Node<T> root;
    private Dictionary<T, Node<T>> elements = new();
    ...
    public void Add(T element, T child)
    {
        ...
        if (elements.ContainsKey(child)) throw new ArgumentException();
    ...
    {
        if (root.Value.Equals(element)) throw new InvalidOperationException();
