...
WHERE JobTitle NOT LIKE '%engineer%'
    - -PROBLEM 5 - Find Towns
with Name Length
SELECT [Name]
FROM Towns
WHERE LEN([Name]) BETWEEN 5 AND 6
ORDER BY [Name] ASC
    --PROBLEM 6 - Find Towns Starting
With
SELECT *
FROM Towns
...
ORDER BY [Name]
    ...
    --PROBLEM 7 - Find Towns Not Starting
With
SELECT *
FROM Towns
WHERE [Name] LIKE '[^RBD]%'
...
ORDER BY Mix
             - -PROBLEM 14 - Problem 14.	Games
from 2011 and 2012 year
SELECT TOP(50)[Name], FORMAT([Start],'yyyy-MM-dd') AS [
Start]
FROM Games
...
ORDER BY Username
             - -PROBLEM 17 - Show All Games
with Duration and Part of the Day
