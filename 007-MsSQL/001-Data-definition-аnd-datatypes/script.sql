...
VALUES ('Ivan O', NULL, 1.24, 55.00, 'm', CONVERT(DateTime, '20000525', 112), 'Mamuna'),
...
INSERT INTO Users
VALUES ('Gosho', '21512', NULL, NULL, 0),
...
VALUES ('Ivan Ivanov', 'Golden boot Winner'),
...
INSERT INTO MOVIES
VALUES ('Gosho and the others', 1, 2020, '1:25:00', 1, 1, 9.9, 'Must watch it with popcorns and wiskey')

INSERT INTO Movies
VALUES ('Hmm part 2', 1, 1999, '1:40:00', 2, 4, 5.0, 'SAW'),
       ('The naked cat', 2, 2999, '1:11:21', 3, 3, 5.3, 'WAS'),
       ('Joe and his women', 4, 2999, '2:12:21', 4, 2, 5.8, 'Whiskey in the Jar'),
       ('Mad cat', 3, 2098, '1:30:01', 5, 1, 2.9, 'Rating 10 not supported') --PROBLEM 14
...
VALUES ('AZ18555PO', 'Michael Smith', 'Medley str. 25', 'Chikago'),
...
VALUES (1, 2, 3, 45, 18005, 19855, '2007-08-08', '2007-08-10', 250, 1),
       (3, 2, 1, 50, 55524, 56984, '2009-09-06', '2009-09-28', 1500, 0),
       (2, 2, 1, 18, 36005, 38547, '2017-05-08', '2017-06-09', 850, 0) --PROBLEM 15
...
VALUES (111, 'single', 'single', 20.0, 1),
...
INSERT INTO Payments(EmployeeId, PaymentDate, AccountNumber, FirstDateOccupied, LastDateOccupied, AmountCharged,
                     TaxRate)
VALUES (3, '2011-11-25', 2, '2017-11-30', '2017-12-04', 250.0, 0.2),
...
VALUES (2, '2015-01-01', 2, 111, 70.0, 12.54),
...
SELECT Salary
FROM Employees --Problem 23
USE Hotel
UPDATE Payments
SET TaxRate -= TaxRate*0.03
SELECT TaxRate
FROM Payments --Problem 24
