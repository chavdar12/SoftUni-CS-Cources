...
FROM WizzardDeposits --Problem 2.	Longest Magic Wand
SELECT MAX(MagicWandSize) AS LongestMagicWand
FROM WizzardDeposits --Problem 3.	Longest Magic Wand per Deposit Groups
SELECT DepositGroup, MAX(MagicWandSize) AS LongestMagicWand
FROM WizzardDeposits
GROUP BY DepositGroup
             - -Problem 4.	* Smallest Deposit
Group per Magic Wand Size
...
ORDER BY TotalSum DESC --Problem 8.	Deposit Charge
...
FROM (SELECT wiz1.DepositAmount - wiz2.DepositAmount AS DepositDifference
      FROM WizzardDeposits AS wiz1
               JOIN WizzardDeposits AS wiz2 ON wiz1.Id = (wiz2.Id + 1)) AS tt --Problem 13.	Departments Total Salaries
-- USE SoftUni
