...
VALUES (7, 'HL Touring Frame',
        ...
        '20050516 16:34:00', NULL)

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (8, 'LL Mountain Frame',
        ...
        '20021120 09:57:00', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (9, 'LL Road Frame',
...
VALUES (20, 'Mountain-200',
        ...
        '20020601', '20040311 10:32:00')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (21, 'Mountain-300',
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (32, 'Short-Sleeve Classic Jersey',
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (37, 'Women''s Mountain Shorts',
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (59, 'LL Headset',
        'Research, design and development of LL Headset. Threadless headset provides quality at an economical price.',
        '20020601', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (60, 'ML Headset', 'Research, design and development of ML Headset. Sealed cartridge keeps dirt out.',
        '20020601', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (61, 'HL Headset',
        'Research, design and development of HL Headset. High-quality 1" threadless headset with a grease port for quick lubrication.',
        '20020601', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (77, 'ML Road Rear Wheel',
        'Research, design and development of ML Road Rear Wheel. Aluminum alloy rim with stainless steel spokes; built for speed.',
        '20020601', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (78, 'HL Road Rear Wheel',
        'Research, design and development of HL Road Rear Wheel. Strong rear wheel with double-walled rim.', '20020601',
        '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (79, 'LL Mountain Seat/Saddle 2',
        'Research, design and development of LL Mountain Seat/Saddle 2. Synthetic leather. Features gel for increased comfort.',
        '20030601', NULL)

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (80, 'ML Mountain Seat/Saddle 2',
        'Research, design and development of ML Mountain Seat/Saddle 2. Designed to absorb shock.', '20030601',
        '20040311 10:32:00')
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (105, 'ML Fork',
        'Research, design and development of ML Fork. Composite road fork with an aluminum steerer tube.', '20020601',
        '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (106, 'HL Fork',
        'Research, design and development of HL Fork. High-performance carbon road fork with curved legs.', '20020601',
        '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (107, 'Hydration Pack',
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (108, 'Taillight',
        'Research, design and development of Taillight. Affordable light for safe night riding - uses 3 AAA batteries',
        '20020601', '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (109, 'Headlights - Dual-Beam',
        'Research, design and development of Headlights - Dual-Beam. Rechargeable dual-beam headlight.', '20020601',
        '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (110, 'Headlights - Weatherproof',
        'Research, design and development of Headlights - Weatherproof. Rugged weatherproof headlight.', '20020601',
        '20030601')

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (111, 'Water Bottle',
        'Research, design and development of Water Bottle. AWC logo water bottle - holds 30 oz; leak-proof.',
        '20030601', NULL)

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (112, 'Mountain Bottle Cage',
        'Research, design and development of Mountain Bottle Cage. Tough aluminum cage holds bottle securly on tough terrain.',
        '20030601', NULL)

INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
VALUES (113, 'Road Bottle Cage',
...
INSERT INTO Projects (ProjectID, Name, Description, StartDate, EndDate)
    VALUES (127, 'Rear Derailleur', 'Research, design and development of Rear Derailleur. Wide-link design.',
            '20030601', NULL)
        GO
...
INSERT INTO Employees (EmployeeID, FirstName, LastName, MiddleName, JobTitle, DepartmentID, ManagerID, HireDate, Salary,
                       AddressID)
...
INSERT INTO Employees (EmployeeID, FirstName, LastName, MiddleName, JobTitle, DepartmentID, ManagerID, HireDate, Salary,
                       AddressID)
VALUES (291, 'Svetlin', 'Nakov', 'Ivanov', 'Independent Software Development  Consultant', 6, NULL, '20050301', 48000,
        291)
...
FROM Employees
ORDER BY Salary DESC --PROBLEM 14
SELECT FirstName, LastName
FROM Employees
WHERE ManagerId != 4
    - -PROBLEM 15
...
FROM Employees
ORDER BY HireDate DESC --PROBLEM 21
SELECT *
FROM Employees
